				...
				<div class="card">
					<div class="card-body">
						...
						<form name="form1" action="update" method="post"
							class="needs-validation" novalidate onsubmit="return myfun();">
							<%
							...
							<div class="form-group">
								...
								<div style="margin-bottom: 1rem"
									...
									<input value="<%=c.getDob()%>" name="dob" type="date"
										id="example" class="form-control" required>
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="inputState">Address Type</label> <select
											name="addtype" id="inputState" class="form-control">
											<option><%=c.getAddtype()%></option>
								...
								<div class="form-group ">
									<label for="exampleInputEmail1">Street/Area/Village</label> <input
										value="<%=c.getStreet()%>" type="text" class="form-control"
								...
								<div class="form-row">
									<div class="form-group col-md-4">
										<label for="inputCity">City</label> <input name="city"
											value="<%=c.getCity()%>" type="text" class="form-control"
									...
									<div class="form-group col-md-2">
										<label for="inputZip">Pin Code</label> <input name="pin"
											value="<%=c.getPin()%>" type="text" class="form-control"
											id="inputZip" required maxlength="6">
								...
								<div class="custom-control custom-checkbox mb-3">
									<input type="checkbox" name="fav" value="true"
										...
										class="custom-control-label" for="fav">Add to
										favorites </label>
								</div>
